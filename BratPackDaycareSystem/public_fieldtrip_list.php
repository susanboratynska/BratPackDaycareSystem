...
if(isset($_GET['fieldtrip__searchkey']) && $_GET['fieldtrip__searchkey'] != ""){
    ...
    $fieldtrip__alltrips = "<a href='public_fieldtrip_list.php' class='btn btn-secondary'>See All Field Trips</a>";
}
...
<div class="container">
    ...
    <div class="page__description">
        If you have any questions, concerns or requests, please contact the <strong>Trip Organizer</strong>. They will be available to provide further details and assistance.
    </div>
    ...
    <table class="table" style="width:100%">
        ...
        <?php foreach ($fieldtrips as $fieldtrip) { ?>
            <tr>
                <td><strong><?= $fieldtrip['location'] ?></strong></td>
                <td><?= $fieldtrip['tripdate'] ?></td>
                <td><?= $fieldtrip['starttime'] . ' - ' . $fieldtrip['endtime'] ?></td>
                <td><a href='public_staffdirectory_show.php?staffID=<?= $fieldtrip['staffID'] ?>' ><?= $fieldtrip['firstname'] . ' ' . $fieldtrip['lastname'] ?></a></td>
                <td>
