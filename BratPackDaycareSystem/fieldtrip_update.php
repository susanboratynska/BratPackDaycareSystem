...
<div class="container">
    ...
    <form method="POST">
        ...
        <div class="form-group row">
            <label for="submit__addtrip" class="col-sm-2 col-form-label"></label>
            <div class="col-sm-6">
                <input class="btn btn-secondary submit__leftalign" name="submit__updatetrip" type="submit" value="Update Field Trip">
            </div>
        </div>
    </form>
</div>
